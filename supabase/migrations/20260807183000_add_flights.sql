...
drop policy if exists "Trip members can view flights" on public.flights;
create policy "Trip members can view flights" on public.flights
for select to authenticated using ((select private.is_trip_member(trip_id)));
drop policy if exists "Trip members can add flights" on public.flights;
create policy "Trip members can add flights" on public.flights
for insert to authenticated with check ((select private.is_trip_member(trip_id)));
drop policy if exists "Trip members can update flights" on public.flights;
create policy "Trip members can update flights" on public.flights
for update to authenticated using ((select private.is_trip_member(trip_id))) with check ((select private.is_trip_member(trip_id)));
drop policy if exists "Trip members can remove flights" on public.flights;
create policy "Trip members can remove flights" on public.flights
